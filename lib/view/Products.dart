                                                                                    ...
                                                                                    Positioned(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () async {
                                                                                          ...
                                                                                          var data = await AuthServices.doo(product_id: controller.listpoduct_discount.elementAt(index).id,token: token);
                                                                                          if (data == "add") {
                                                                                            print(data);
                                                                                  ...
                                                                                  Positioned(
                                                                                    ...
                                                                                    child: InkWell(
                                                                                      onTap: () async {
                                                                                        ...
                                                                                        var data = await AuthServices.doo(product_id: controller.listpoduct_favorite.elementAt(index).id,token: token);
                                                                                        if (data == "add") {
                                                                                          print(data);
                                                                                    ...
                                                                                    Positioned(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () async {
                                                                                          ...
                                                                                          var data = await AuthServices.doo(product_id: controller.listpoduct_sales.elementAt(index).id,token: token);
                                                                                          if (data == "add") {
                                                                                    ...
                                                                                    Positioned(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () async {
                                                                                          ...
                                                                                          var data = await AuthServices.doo(product_id: controller.listpoduct_salary.elementAt(index).id,token: token);
                                                                                          if (data == "add") {
                                                                                            print(data);
